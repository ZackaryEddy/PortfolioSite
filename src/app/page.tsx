...
export default function Home() {
  return (
    ...
    <div className="min-h-screen bg-coral-50 dark:bg-gray-900 transition-colors">
      {/* Hero Section - Full-screen intro with background image and call-to-action buttons */}
      <section
        id="home"
        className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-coral-50 to-coral-100 dark:from-gray-900 dark:to-gray-800 transition-colors"
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl md:text-2xl text-slate-700 dark:text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            I&apos;m Zack Eddy, the developer behind Sparkline Pro. I
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="#services"
              className="border-2 border-slate-300 dark:border-gray-600 text-slate-900 dark:text-white hover:bg-slate-100 dark:hover:bg-gray-800 px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-200 text-center"
            >
              View My Services
            </a>
          </div>
      ...
      <section
        id="services"
        className="py-20 px-6 bg-coral-100 dark:bg-gray-800 transition-colors"
      >
      ...
      <section className="py-20 px-6 bg-coral-50 dark:bg-gray-900 transition-colors">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
      ...
      <section
        id="contact"
        className="py-20 px-6 bg-coral-50 dark:bg-gray-900 transition-colors"
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-700 dark:text-gray-300 leading-relaxed max-w-3xl mx-auto">
      ...
      <div className="bg-coral-100 dark:bg-gray-800 border-t border-coral-200 dark:border-gray-700 py-6">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-2 md:space-y-0">
            ...
            <div className="bg-coral-200 dark:bg-gray-700 px-2 py-3 rounded-lg max-w-lg">
